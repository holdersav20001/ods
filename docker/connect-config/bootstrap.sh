...
for f in /cfg/jdbc-sink-policies.json /cfg/jdbc-sink-policy-history.json /cfg/jdbc-sink-risk.json /cfg/jdbc-sink-api-pull-demo.json /cfg/jdbc-sink-api-pull-risk.json /cfg/jdbc-sink-api-pull-lowlat-demo.json /cfg/s3-sink-policies.json /cfg/s3-sink-api-pull-lowlat-demo.json; do
